...
1. Download the APK of the app you'd like to analyze (e.g., google search "[App Name] APK") and open in jadx-gui. Note: if the file is .xapk, rename to .zip and open to find the actual .apk. Note: be cautious under what security environment you download and load any unknown 3rd-party software.
